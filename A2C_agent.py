...
def a2c_evaluate(model, env, profiles, episodes=None):
...
def run_episodic_a2c_agent(args, worker_idx=None):
    ...
    while z < 5:
        ...
        if args.do_testing:
            avg_reward, std = a2c_evaluate(model, env, test_profiles)
